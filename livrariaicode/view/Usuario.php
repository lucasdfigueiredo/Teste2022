...
<div class="page-content">
        <div class="form-v9-content" style="background-image: url('images/form-v9.jpg')">
            <form class="form-detail" action="../command/cadUsuario.php" method="post">
                <h2>CADASTRAR-SE</h2>
                <div class="form-row-total">
                    <div class="form-row">
                        <input type="text" name="txtNome" id="full-name" class="input-text" placeholder="Seu Nome..." required>
                    </div>
                    <div class="form-row">
                        <input type="text" name="txtEmail" id="your-email" class="input-text" placeholder="Seu E-mail..." required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
                    </div>
                </div>
                <div class="form-row-total">
                    <div class="form-row">
                        <input type="password" name="txtSenha" id="password" class="input-text" placeholder="Sua Senha..." required>
                    </div>
                    <div class="form-row">
                        <input type="password" name="txtConfsenha" id="comfirm-password" class="input-text" placeholder="Comfirme a Senha..." required>
                    </div>
                </div>
